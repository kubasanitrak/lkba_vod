...
<div class="section" data-theme="default">
            ...
            <h1 class="entry-title"><?php printf( __( 'Search Results for: %s', 'lkba_vod' ), get_search_query() ); ?></h1>
</div>
<div class="section" data-theme="default">
	...
	<div class="article-item flow mar-B">
		...
		<div class="article-item--footer">
            <div class="wp-block-button is-style-outline">
                <a class="wp-block-button__link" href="<?php the_permalink();?>"><?php _e('Read full article', 'lkba_vod'); ?></a>
            </div>
        </div>
	</div>
<?php endwhile; ?>
<?php else : ?>
    ...
    <div class="flow mar-B">
		<h2 class="entry-title"><?php _e( 'Nothing Found', 'lkba_vod' ); ?></h2>
		<p><?php _e( 'Sorry, nothing matched your search. Please try again.', 'lkba_vod' ); ?></p>
	<!-- </div> -->
<?php endif; ?>
