...
function lkba_login_logo() {
	...
	<style type="text/css">
		...
		.login #loginform {
			background-color: hsl(41deg, 41%, 93%);
			box-shadow: none;
			border-color: transparent; /*#CCC5B5;*/
		}
		#login h1, .login h1 {
			padding-top: calc(48px + (16 - 48) * ((100vw - 320px) / (2560 - 320)));
		}
		#login h1 a, .login h1 a {
			...
			/*height: 150px;*/
			height: calc(96px + (150 - 96) * ((100vw - 320px) / (2560 - 320)));
			/*width: 320px;*/
			width: calc(180px + (320 - 180) * ((100vw - 320px) / (2560 - 320)));
